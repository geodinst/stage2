...
(function() {
  ...
  $.fn.sieve = function(options) {
    ...
    return this.each(function() {
      ...
      settings = $.extend({
        searchInput: null,
        searchTemplate: "<div class = \"element-search\"><label>Search: <input type='text'class= 'form-text required'></label></div>",
      ...
      return settings.searchInput.on("keyup.sieve change.sieve", function() {
        ...
        items.each(function() {
          ...
          if (settings.textSelector) {
            ...
            text=cells.map(function(){return $(this).val().toLowerCase();}).get().join('');
          } else {
